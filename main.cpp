...
void GenerateCloudBaseShapeNoise()
{
	...
	NoiseKernel cloudBaseShape([&](unsigned int s, unsigned int t, unsigned int r, unsigned char& red, unsigned char& green, unsigned char& blue, unsigned char& alpha)
	{
		...
		green = unsigned char(255.0f*value);
		blue = unsigned char(255.0f*value);
...

	{
		...
		writeDDS("noiseShapePacked.dds", cloudBaseShapeTextureSize, cloudBaseShapeTextureSize, cloudBaseShapeTextureSize, cloudBaseShapeTexelsPacked.get());
	}
}

void GenerateCloudErosion()
{
...

	{
		...
		writeDDS("noiseErosionPacked.dds", cloudErosionTextureSize, cloudErosionTextureSize, cloudErosionTextureSize, cloudErosionTexelsPacked.get());
	}
}
...
{   
	...
	//
	GenerateCloudBaseShapeNoise();
	GenerateCloudErosion();
